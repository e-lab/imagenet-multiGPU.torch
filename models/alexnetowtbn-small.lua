...
function createModel(nGPU)
   ...
   features:add(nn.SpatialConvolution(64,192,5,5,2,2))       --  36 -> 16
   features:add(nn.SpatialBatchNormalization(192,1e-3))
   features:add(nn.ReLU(true))
   features:add(nn.SpatialMaxPooling(2,2,2,2))                   --  16 ->  8
   features:add(nn.SpatialConvolution(192,384,3,3,1,1,1,1))      --  8 ->  8
   features:add(nn.SpatialBatchNormalization(384,1e-3))
   features:add(nn.ReLU(true))
   features:add(nn.SpatialConvolution(384,256,3,3,1,1,1,1))      --  8 ->  8
   features:add(nn.SpatialBatchNormalization(256,1e-3))
   features:add(nn.ReLU(true))
   features:add(nn.SpatialConvolution(256,256,3,3,1,1,1,1))      --  8 ->  8
   features:add(nn.SpatialBatchNormalization(256,1e-3))
   features:add(nn.ReLU(true))
   features:add(nn.SpatialAveragePooling(8, 8, 1, 1, 0, 0))      --  8 ->  1
